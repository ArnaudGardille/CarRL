...
class DQLAgent(object):
    def __init__(
            self, state_size=10, action_size=15,
            max_steps=200, gamma=1.0, epsilon=0.5, learning_rate=0.1):
    ...
    def build_model(self):
        ...
        model.add(keras.layers.Dense(self.action_size, input_dim=20, activation='softmax'))
